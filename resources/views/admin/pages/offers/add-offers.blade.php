                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{url('/admin/add-offers',$propertyId)}}" method="post">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="email" name="email_address" class="form-control" value="{{old('email_address')}}" placeholder="Enter address">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">Brokerage Name<span style="color: red;">*</span></label>
                                                <input type="text" name="brokerage_name" class="form-control" value="{{old('brokerage_name')}}" placeholder="Enter brokerage name">
