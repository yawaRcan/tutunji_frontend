                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{url('/admin/edit-offers',$offer_data[0]->id)}}" method="post">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="full_name" class="form-control" value="{{(Input::old('full_name')) ? Input::old('full_name') : $offer_data[0]->full_name }}" placeholder="Enter full name">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">Phone Number<span style="color: red;">*</span></label>
                                                <input type="text" name="phone_number" class="form-control" value="{{(Input::old('phone_number')) ? Input::old('phone_number') : $offer_data[0]->phone_number }}" placeholder="Enter phone number">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">Email Address<span style="color: red;">*</span></label>
                                                <input type="email" name="email_address" class="form-control" value="{{(Input::old('email_address')) ? Input::old('email_address') : $offer_data[0]->email_address }}" placeholder="Enter address">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">Brokerage Name<span style="color: red;">*</span></label>
                                                <input type="text" name="brokerage_name" class="form-control" value="{{(Input::old('brokerage_name')) ? Input::old('brokerage_name') : $offer_data[0]->brokerage_name }}" placeholder="Enter brokerage name">
