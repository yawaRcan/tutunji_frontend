...
<!-- title -->
@section('title')
    <title> Add Pre-Construction Property </title>
    {{--    <style>--}}
    {{--        input[type="file"] {--}}
    {{--            display: none;--}}
    {{--        }--}}
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Add Pre-Construction Property</h1>
                    </div>
                    {{--                    <div class="col-sm-6">--}}
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header" style="background-color: #1ED65f">
                                <h3 class="card-title">Add Pre-Construction Property</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{url('/admin/add-pre-construct-property')}}" method="post" enctype="multipart/form-data" id="myForm">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            {{--                                                 <p style="color: grey">Dimension (1350 X 820)</p>--}}
                                            <!-- loader -->
                                            ...
                                            <p style="color: grey">* Only WebP file type is allowed.</p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <!-- 369 X 117 -->
                                            <label>Banner 5 Dimension (1404 x 445)</label><br>
                                            <!-- loader -->
                                        ...
                                        <div class="col-md-6">
                                            <label>Banner 6 Dimension (1404 x 445)</label><br>
                                            <!-- loader -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label>Banner 7 Dimension (1404 x 445)</label><br>
                                            <!-- loader -->
                                            ...
                                            <div class="text-center" style="border: 1px solid lightgrey;padding: 20px;" id="floor_2d_plan">
                                                ...
                                                <div class="row" id="floor_plan_2d_upload_section">
                                                    <div class="col-md-12">
                                                        ...
                                                        {{--                                                       <span id="2d_file_type_error_msg" class="text-danger"></span>--}}
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                    ...
                                    <div class="row" >
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <span id="doc1_type_success_msg" class="text-success"></span>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <span id="doc2_type_success_msg" class="text-success"></span>
                                            <p style="color: grey;">* Upload html files only.</p>
                                        </div>
                                    </div>
                                    <div class="row">
...
{{--                                        </div>--}}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="from_size_in_ft" class="form-control" placeholder="Enter from size in sqft">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">To Size In SqFt</label>
                                                <input type="text" name="to_size_in_ft" class="form-control" placeholder="Enter to size in sqft">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">From Rooms</label>
                                                <input type="text" name="from_rooms" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" placeholder="Enter from rooms">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">To Rooms</label>
                                                <input type="text" name="to_rooms" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" placeholder="Enter to rooms">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">From Bedrooms</label>
                                                <input type="text" name="from_bedrooms" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" placeholder="Enter from bedrooms">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">To Bedrooms</label>
                                                <input type="text" name="to_bedrooms" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" placeholder="Enter to bedrooms">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">From Bathrooms</label>
                                                <input type="text" name="from_bathrooms" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" placeholder="Enter from bathrooms">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">To Bathrooms</label>
                                                <input type="text" name="to_bathrooms" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" placeholder="Enter to bathrooms">
                                            </div>
                                        </div>
                                        {{--                                        <div class="col-md-6">--}}
                                        {{--                                            <div class="form-group">--}}
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="from_parking_spots" class="form-control" placeholder="Enter from parking spots">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">To Parking Spots</label>
                                                <input type="text" name="to_parking_spots" class="form-control" placeholder="Enter to parking spots">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">Approximate Completion Date</label>
                                                <input type="date" name="year_built" class="form-control"  placeholder="Enter Approximate Completion Date" pattern="[0-9\s\$@%~#^&*-]+" value="{{old('year_built')}}">
                                            </div>
                                        </div>
                                        {{--                                        <div class="col-md-6">--}}
                                        {{--                                            <div class="form-group">--}}
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="fileUpload btn btn-success" style="background-color: #1ED65F;border-color: #1ED65F;margin-bottom: 0;margin-left: 0;margin-top: 5px;" id="update_floor_plan_2d_btn">
                                                <span>SELECT PLAN</span>
                                            ...
                                            <span class="text-success" id="update-floor-plan-2d-success-msg"></span>
                                            {{--                                            <span class="text-success" id="update-floor-plan-2d-success-msg"></span>--}}
                                            <!-- update 2d image preview -->
                            ...
                            <div class="modal fade" id="update_3d_floor_detail" role="dialog">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Update 3D Floor Plan Detail</h4>
                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                        </div>
                                        <div class="modal-body">
                                            ...
                                            <div class="fileUpload btn btn-success" style="background-color: #1ED65F;border-color: #1ED65F;margin-bottom: 0;margin-left: 0;margin-top: 5px;" id="update_floor_plan_3d_btn">
                                                <span>SELECT PLAN</span>
                                            ...
                                            <span class="text-success" id="update-floor-plan-3d-success-msg"></span>
                    ...
                    success     : function(result) {
                        ...
                        if(result.code == 200) {
                            ...
                            $('#image_preview').append(
                                ...
                                "<div class='image' id='img-remove_"+result.data.id+"'>" + file +
                                "<br>" +
    ...
    <script>
        $('#select_btn').click(function (){
            ...
            if(bathroom == '' && bedroom == '' && sqft == '') {
                ...
                $("#2d_file_error").empty().append('Please select floor plan.');
                $('#floor-plan-2d-alert-msg').empty();
                $('#2d_file_type_error_msg').empty()
                $('#2d_file_success').empty();
            }
            else {
                $("#2d_bath_error").empty();
        ...
        // //update floor plan 2d type
        // $(document).ready(function (){
        //     $('#2d_file_update').change(function (){
        //         let imageType = this.files[0].type;
        //         // alert(imageType);
        //         if(imageType != 'image/webp' || imageType != 'image/png' || imageType != 'image/jpeg'){
        //             $('#edit_2d_file_type_error_msg').empty().append('Only png, jpeg & webp file types are allowed.');
        //         }
        //     });
        // });
            ...
            $.ajax({
                ...
                success     : function (response) {
                    ...
                    if(response.code == 404){
                        ...
                        $('#update-floor-plan-2d-success-msg').empty();
                    }else if(response.code == 400){
                        $('#update-floor-plan-2d-error-msg').empty().append(response.message);
                        $('#update-floor-plan-2d-success-msg').empty();
                    }else{
                        ...
                        $('#floor-plan-2d-error-msg').empty();
                        $('#update-floor-plan-2d-success-msg').empty();
                        $('#update-floor-plan-2d-error-msg').empty();
        ...
        $('#2d_file_update').change(function (){
            var select_file = $('#2d_file_update').val();
            if(select_file != ''){
                $('#update-floor-plan-2d-success-msg').empty().append('Uploaded');
            }
        });
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response.code === 200) {
                                // $("#floor-plan-2d-alert-msg").empty().append('Floor plan 2D deleted!');
    ...
    <script>
        $('#select_f_3d_btn').click(function (){
            ...
            if(bathroom == '' && bedroom == '' && sqft == '') {
                ...
                $.ajax({
                    type    : 'post',
                    url     : '{{url('admin/update-3d-section-on-session')}}',
                    cache       : false,
                    contentType : false,
                    processData : false,
                    data    : postData,
                    success : function (response){
                        ...
                        console.log(response);
                        if(response.status == 404) {
                            $('#floor-plan-3d-error-msg').empty().append('Only png, jpg and webp file types are allowed.');
        ...
        $('#3d_file_update').change(function (){
            var select_file = $('#3d_file_update').val();
            if(select_file != ''){
                $('#update-floor-plan-3d-success-msg').empty().append('Uploaded');
            }
        });
            ...
            $.ajax({
                ...
                success     : function (response) {
                    ...
                    if(response.code == 404){
                        ...
                        $('#update-floor-plan-3d-success-msg').empty();
                        ...
                        $('#floor-plan-3d-error-msg').empty();
                        $('#update-floor-plan-3d-success-msg').empty();
                        $('#update-floor-plan-3d-error-msg').empty();
    ...
    <!-- floor plan input numbers only script -->
        ...
        $(document).ready(function(){
            $(document).on('change','#signUp_file',function(){
                ...
                if(type != 'text/html'){
                    ...
                    $('#doc1_type_success_msg').empty();
                }else{
                    $('#doc1_type_success_msg').empty().append('Uploaded');
        ...
        $(document).ready(function(){
            $(document).on('change','#newsletter_file',function(){
                ...
                if(type != 'text/html'){
                    ...
                    $('#doc2_type_success_msg').empty();
                }else{
                    $('#doc2_type_success_msg').empty().append('Uploaded');
