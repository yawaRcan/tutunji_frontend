...
@section('title')
    <title> All Approve Sale/Lease Properties </title>
@endsection
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1> All Approve Sale/Lease Property</h1>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        </section>
                ...
                <div class="col-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title">List of Approve Sale/Lease Property</h3>
                        ...
                        <div class="card-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                @php($no = 1)
                                @foreach($approve_sale_property as $saleData)
                                    <tr>
                                        <td>{{$no++}}</td>
