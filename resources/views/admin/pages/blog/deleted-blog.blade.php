...
{{--                                    <th>Category</th>--}}
                                ...
                                <tbody>
                                @php($no = 1)
                                @foreach($deleted_blog as $blogDetail)
                                    <tr>
                                        <td>{{$no++}}</td>
...
{{--                                        <td>{{($blogDetail['category_details']['name']) ? $blogDetail['category_details']['name'] : '-'}}</td>--}}
                                        ...
                                        <td>@can('view_only')
                                                ...
                                                @if($blogDetail->status == 1)
                                                    <a href="{{url('/admin/delete-blog',[$blogDetail->id])}}" class="btn btn-primary btn-sm show_confirm" style="background-color: #949496;border-color: #949496;"><i class="fa fa-trash-alt"></i></a>                                                    {{--                                                @else--}}
