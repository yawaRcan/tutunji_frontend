                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{url('/admin/edit-blog',$blogData[0]->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" class="form-control" value="{{$blogData[0]->title}}" placeholder="Enter title">
                                                <!-- validation-error-message -->
...
{{--                                                        <option value="{{$catData->id}}" @if($blogData[0]->category == $catData->id) ? selected : null @endif>{{$catData->name}}</option>--}}
{{--                                                    @endforeach--}}
{{--                                                </select>--}}
{{--                                                <!-- validation-error-message -->--}}
...
{{--                                        </div>--}}
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="file" name="image" id="image" onchange="document.getElementById('img-output').src = window.URL.createObjectURL(this.files[0])"><br><br>
                                                @if($blogData[0]->image)
                                                    <img src="{{asset('admin-panel/assets/blog-image/'.$blogData[0]->image)}}" id="img-output" class="profile-img" height="150px" width="150px">
                                                @else
...
{{--                                                     alt="preview image" style="max-height: 250px;">--}}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="mb-3">
                                                    <textarea class="textarea" name="body" id="body" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$blogData[0]->body}}</textarea>
                                                    <!-- validation-error-message -->
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="middleBanner" class="form-control" value="{{$blogData[0]->middleBanner}}" placeholder="Enter middle banner">
                                                <!-- validation-error-message -->
