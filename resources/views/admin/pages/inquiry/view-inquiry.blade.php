                        ...
                        <div class="card-header">
                            ...
                            <div class="text-right">
                                @can('view_only')
                                    ...
                                    <a href="{{url('/admin/add-inquiry',$inquiryId)}}" class="btn btn-sm btn-primary" style="background-color: #1ED65F;border-color: #1ED65F;"><i class="fa fa-plus-circle"></i> Add Submission</a>
                                @endcan
                                @if(Auth::guard('admin')->user()->role == 1)<i class="fa fa-minus" style="color: #949496;display: none;"></i>@else<i class="fa fa-minus" style="color: #949496"></i>@endif
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                @foreach($inquiryData as $i_detail)
                                    <tr>
                                        <td>{{$no++}}</td>
                                        <td>{{date('m/d/Y H:i',strtotime($i_detail['created_at']))}}</td>
                                        ...
                                        <td>
                                            @can('view_only')
                                                <a href="{{url('/admin/edit-inquiry',$i_detail['id'])}}" class="btn btn-primary btn-sm" style="background-color: #1ED65F;border-color: #1ED65F;"><i class="fa fa-edit"></i></a>
                                                <a href="{{url('/admin/delete-inquiry',$i_detail['id'])}}" class="btn btn-primary btn-sm delete-confirm" style="background-color: #949496;border-color: #949496;"><i class="fa fa-trash"></i></a>
                                            @endcan
