...
<div class="login-box">
    <div class="login-logo">
        <a href="../../index2.html"><img src="{{asset('frontend/assets/imgs/LogoTransparent.png')}}"></a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
...
{{--                    </div>--}}
                    <!-- /.col -->
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary btn-block" style="background-color: #1ED65F;border-color: #1ED65F;">Sign In</button>
                    </div>
                    <!-- /.col -->
                </div>
            </form>
