                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{url('/admin/edit-category',$cat_data[0]->id)}}" method="post">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control" value="{{old('name') ?? $cat_data[0]->name}}" placeholder="Enter name">
                                                <!-- validation error message -->
