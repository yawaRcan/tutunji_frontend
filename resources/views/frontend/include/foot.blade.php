    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 text-grey center">
                © 2021-<?php echo date('Y'); ?> Tutunji Realty Inc. | <span class="line-br-mobile">ALL RIGHTS RESERVED</span>
            </div>
...
<script>
    ...
    window.addEventListener('scroll', function() {
      ...
      var button = document.getElementById('agentButton');

      var rect = section.getBoundingClientRect();
      var sectionTop = rect.top;

      var screenWidth = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth;
      var isMobile = screenWidth <= 767; // Adjust the threshold as per your requirements
