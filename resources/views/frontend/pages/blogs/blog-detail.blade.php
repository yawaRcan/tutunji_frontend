        ...
        <div class="row mt-20">
            <div class="col-lg-12">
                <ul class="list-unstyled list-inline text-greyishblack">
                    <li class="list-inline-item">Posted : {{$post_time}}</li>
                    <li class="list-inline-item">|</li>
                    <li class="list-inline-item">Share </li>
                    <li class="list-inline-item"><i class="fas fa-share"></i></li>
                    <li class="list-inline-item"><a href="https://www.facebook.com/sharer/sharer.php?u=https://www.tutunjirealty.com/demo/public" target="_blank" class="text-greyishblack"><i class="fab fa-facebook fa-lg"></i></a></li>
                    <li class="list-inline-item"><a href="https://twitter.com/intent/tweet?text=Check+out+this+Real+Estate+blog%21&url=https://www.tutunjirealty.com/demo/public" target="_blank" class="text-greyishblack"><i class="fab fa-twitter fa-lg"></i></a></li>
{{--                    <li class="list-inline-item"><a href="#" class="text-greyishblack"><img src="{{asset('')}}frontend/assets/imgs/instagram.png" alt="" class="img-fluid"></a></li>--}}
{{--                    <li class="list-inline-item"><a href="#" class="text-greyishblack"><img src="{{asset('')}}frontend/assets/imgs/Group%20271.png" alt="" class="img-fluid"></a></li>--}}
                    <li class="list-inline-item"><a href="https://www.linkedin.com/sharing/share-offsite?mini=true&url=https://www.tutunjirealty.com/demo/public&title=Check+out+this+Real+Estate+blog%21&summary=" target="_blank" class="text-greyishblack"><i class="fab fa-linkedin fa-lg"></i></a></li>
...
{{--                    <li class="list-inline-item"><a href="#"><img src="{{asset('')}}frontend/assets/imgs/tiktok.svg" alt="" class="img-fluid"></a></li>--}}
        ...
        <div class="row mt-40">
            <div class="col-lg-12">
                <h4 class="fs-20 fw-700 text-deco">More Blogs</h4>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12 pr-0 pl-0">
                <div class="owl-carousel blog-carousel1 owl-theme">
                    ...
                    <div class="item">
                        <a href="{{url('blog-detail',$similarData->id)}}" style="color: #164DF3; text-decoration: none;">
                        <div class="card">
                            @if($similarData->image)
                                <img src="{{asset('admin-panel/assets/blog-image/'.$similarData->image)}}" class="card-img-top" alt="...">
                            @else
                                <img src="{{asset('default/404-not-found.jpg')}}" class="card-img-top" alt="...">
                            @endif
                            <div class="card-body">
                                <h5 class="card-title">{{$similarData->title ? $similarData->title : '-'}}</h5>
                                <p class="card-text">{{\Illuminate\Support\Str::limit($similarData->body ? $similarData->body : '-', 170)}}
