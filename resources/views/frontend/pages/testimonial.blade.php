...
<div class="bg-silver testimonial-header">
    <h1 class="fs-40 fw-700 mb-0">Testimonials</h1>
</div>
<div class="bg-grey pb-0">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="fs-40 text-center">Client <span class="fw-700">Success Stories </span></h1>
            </div>
        </div>
        <div class="row mt-40">
            <div class="col-lg-6 center">
                <h2 class="fs-34 fw-700">Review "Title"</h2>
                <div class="embed-responsive embed-responsive-16by9 d-lg-none my-3">
                    <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/f3NWvUV8MD8?rel=0"
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 offset-lg-4">
                <h1 class="fs-40 text-center bb-2 fw-700" style="border-bottom: 2px dashed #000000;color: #000000;">
                    Contact Us</h1>
            </div>
        </div>
        <div class="row mt-40">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" placeholder="Robison Croso"
                                value="{{old('name')}}">
                        </div>
                        <div class="form-group">
                            <label>Your Phone Number</label>
                            <input type="text" class="form-control" id="phone" name="phone" placeholder="+416 123 4567"
                                value="{{old('phone')}}">
                        </div>
                        <div class="form-group">
                            <label>Your Email Address</label>
                            <input type="email" class="form-control" id="email" name="email"
                                placeholder="example@box.com" value="{{old('email')}}">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            {{-- <input type="text" class="form-control" id="subject" name="subject"
                                placeholder="write your service here" value="{{old('subject')}}">--}}
